...
from robodm_trajectory_dataset import RoboDMTrajectoryDataset
...
def main():
    ...
    dataset = RoboDMTrajectoryDataset(trajectory_path="./tmp/robot_demoNew25650.vla", delta_timestamps=delta_timestamps, dataset_metadata=dataset_metadata)
